...
class BTAssessor(Assessor):
    ...
    def assess_trial(self, trial_id, result_dict_list):
        ...
        logger.info('dict!!')
        logger.info(self.etr.info_dict)
        BTMessenger(trial_id).write_assessor_info(self.etr.info_dict)
...
class MyAssessor:
    def __init__(self, shared, basic, compare, diagnose, seed=None):
        ...
        self.symptom_name_list = self.basic["symptom_name_list"] 
